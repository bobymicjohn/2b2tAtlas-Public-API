...
are needed for this workflow. The tight Chunk Haven proposal remains rejected
because it excludes outer builds; other ambiguous crops await extent review.
